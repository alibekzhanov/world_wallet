...
const currencyCodes = [
    ...
    "TTD", "TVD", "TWD", "TZS", "UAH", "UGX", "USD", "UYU", "UZS", "VED", 
    "VES", "VND", "VUV", "WST", "XAF", "XCD", "XDR", "XOF", "XPF", "YER", 
    "ZAR", "ZMW", "ZWL"
];

const CurrencySelect = ({selectedCurrency, handleCurrency}) => {
    // Extract the country code froom the selected currency code
    ...
    return (
        <div className="currency_select">
            ...
            <select onChange={handleCurrency} className="currency_dropdown" value={selectedCurrency}>
